...
namespace TwitchBot.Service.Features.MediatR.Handlers
{
    public class TwitchShrinkCommandHandler : INotificationHandler<ShrinkCommand>
    {
        ...
        public TwitchShrinkCommandHandler(OBSServices obs, TwitchClientServices api)
        {
            _obs = obs;
            _api = api;
        }

        public async Task Handle(ShrinkCommand notification, CancellationToken cancellationToken)
        {
